...
* The original package name 'com.spring.native.springNative' is invalid and this project uses 'com.example.demo' instead.
...
```
$ docker run --rm springNative:0.0.1-SNAPSHOT
```
